import { FaBox, FaDollarSign, FaEdit } from "react-icons/fa";
...
const DeliverySection = () => {
  const features = [
    ...
    {
      icon: <FaDollarSign className="w-8 h-8 mb-4 text-gray-700" />,
      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col sm:flex-row justify-between items-center">
          {features.map((feature, index) => (
            <div
              key={index}
              className="flex flex-col items-center text-center p-4 sm:w-1/3"
            >
              {feature.icon}
