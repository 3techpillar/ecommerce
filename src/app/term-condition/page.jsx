    ...
    <div>
      ...
      <div className="bg-white py-10">
        <div className="max-w-4xl mx-auto p-8 bg-white">
          ...
          <h3 className="text-2xl font-semibold mb-4">Use of the Site</h3>
          <p className="mb-4">
          ...
          <h3 className="text-2xl font-semibold mb-4">Accounts</h3>
          <p className="mb-4">
          ...
          <h3 className="text-2xl font-semibold mb-4">Purchases</h3>
          <p className="mb-4">
